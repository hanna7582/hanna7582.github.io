...
var loginObj = {
    ...
    moveLogin : function(returnUrl){
        location.replace( loginObj.pagePath + (loginObj.isDevice != 'N' ? '/m' : '') + '/login/login.do?returnUrl='+ encodeURIComponent((returnUrl == undefined || returnUrl == '' ? location.href : returnUrl)));
    }    
};
